...
int main ()
{
   ...
   while (Choice != ExitChoice)
   {
	   ...
	   if (Choice == 'B')
	   {
			...
			Price = CalculatePrice("Business", BUSINESS_PRICE, NumSeats);
	   }	
       ...
       // Ask if they want to continue (Y or N)
		Choice = GetYorN("Would you like to continue?");
   }
   ...
   cout << "You ordered a total of " << noshowpoint << setprecision(0)
		<< TotalSeats << " seat(s) which came to $" << showpoint 
